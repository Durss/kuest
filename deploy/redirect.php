...
<html>
	...
	<body style="text-align:center;">
		<div id="redirectDiv" style="display:none;">Si vous n'êtes pas redirigé, <a href="http://kube.muxxu.com/?kuest=<?php echo $_GET['kuest'];?>" target="_blank">cliquez ici</a>.<br /></div>
		...
		<script type="text/javascript">
			...
			target.location = "http://kube.muxxu.com/?kuest=<?php echo $_GET['kuest'];?>";
