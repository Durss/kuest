package com.twinoid.kube.quest.editor.utils {
	...
	/**
	 * Registers classes aliases so that the kuest can be saved as a ByteArray
	 * in a real easy way.
	 * By the way, the method makes sure that all the kuest's specific classes
	 * have getters AND setters for every important property. That way we are
	 * sure that the data will be restored properly. 
	 * 
	 * @author Francois
	 */
